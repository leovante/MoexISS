...
import ru.exdata.moex.component.urlbuilder.response.Response;
import ru.exdata.moex.component.urlbuilder.response.JsonResponseMapper;
...
public final class Format {
    ...
    public Format(final HttpClient httpClient, final URI uri, final Query query) {
