...
public final class Security {
    ...
    public Format format() {
        return new Format(securities.board.boards.session.sessions.market.markets.engine.engines.history.iss.issClient.httpClient, securities.board.boards.session.sessions.market.markets.engine.engines.history.iss.issClient.uri, this.query);
    }
}
